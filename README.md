...
The system follows a layered microservices architecture using the Hexagonal Architecture (Ports & Adapters) pattern. Each layer is independently deployable via Docker.
