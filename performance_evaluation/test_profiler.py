...
def test_performance_analyzer():
    ...
    csv_paths = [
        'performance_evaluation/results/test_metrics.csv',  # From repo root
        'results/test_metrics.csv'  # From performance_evaluation dir
    ]
    ...
    if not csv_file:
        print(f"⚠️  CSV file not found in any of: {csv_paths}")
        print("Run test_system_profiler first")
        return
